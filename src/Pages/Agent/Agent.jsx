import { FaFacebook, FaInstagram, FaLinkedin, FaTwitter } from "react-icons/fa";
 import '../../Components/Style/hovering/hovering.css'
        ...
        <section className="mt-7 space-y-3 p-2">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                <article className="rounded border">
                    <div className="">
                        <img className="h-full w-full" src="https://i.ibb.co/260H64Q/af6.jpg" alt="" />
                    </div>
                    ...
                    <div id="content-agent" className="p-4 space-y-2">
                      ...
                      <div className="flex gap-1 justify-center">
                        <FaFacebook className="text-[33px] rounded-full border-2 p-1 border-gray" ></FaFacebook>
                        <FaTwitter className="text-[33px] rounded-full border-2 p-1 border-gray"></FaTwitter>
                        <FaInstagram className="text-[33px] rounded-full border-2 p-1 border-gray"></FaInstagram>
                        <FaLinkedin className="text-[33px] rounded-full border-2 p-1 border-gray"></FaLinkedin>
                      </div>
                    </div>
                </article>
                <article className="rounded border">
                    <div className="">
                        <img className="w-full" src="https://i.ibb.co/fr5ZgPL/af5.jpg" alt="" />
                    </div>
                ...
                <article className="rounded border">
                    <div>
                        <img className="w-full" src="https://i.ibb.co/mhCvm4c/af4.jpg" alt="" />
                    </div>
                ...
                <article className="rounded border">
                    <div>
                        <img className="w-full" src="https://i.ibb.co/BZnNp2K/af1.jpg" alt="" />
                    </div>
                ...
                <article className="rounded border">
                    <div>
                        <img className="w-full" src="https://i.ibb.co/H7sVr4R/af2.jpg" alt="" />
                    </div>
           ...
           <aside className="mt-11">
            <div className="flex flex-col items-center justify-center">
                 <h1 className="text-[44px] font-bold text-center animate__animated animate__fadeInLeft">Why We Are <span className="text-[#ff0000]">The Best.</span> </h1>
            <div className="flex">
                           <div className="w-[90px] h-[7px] bg-blue-500"></div>
             <div className="w-[90px] h-[7px] bg-violet-500"></div>
            </div>
            </div>
